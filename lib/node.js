...
Node.prototype.merge = function(rSib){
  assert.equal(this.constructor, rSib.constructor)

  this.keys     = this.keys.concat(rSib.keys)
  this.children = this.children.concat(rSib.children)
  //Array.prototype.push.apply(this.keys, rSib.keys)
  //Array.prototype.push.apply(this.children, rSib.children)
...
/**
 * Perform a merge operation on this Node and its immediate left sibling.
 *
 * @param {Node} lSib
 * @returns {Node} this node
 */
Node.prototype.lMerge = function(lSib){
  assert.equal(this.constructor, lSib.constructor)

  this.keys     = lSib.keys.concat(this.keys)
  this.children = lSib.children.concat(this.children)
  //Array.prototype.push.apply(this.keys, lSib.keys)
  //Array.prototype.push.apply(this.children, lSib.children)
